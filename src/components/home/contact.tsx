      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8 px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col justify-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-2 leading-snug">
            Hubungi Tim <span className="text-orange-600">Nusantara Kuliner.</span>
          </h2>
          <p className="text-gray-700 mb-6 text-lg">
            Mari terhubung & nikmati rasa <b className="font-semibold">Nusantara</b> lebih dekat.<br />
            Pesan produk, tanya detail, atau ajukan kerja sama.
          </p>
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <input type="text" name="nama" required placeholder="Nama *" className="border rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-orange-400" />
            <input type="email" name="email" required placeholder="Email *" className="border rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-orange-400" />
            <input type="text" name="whatsapp" required placeholder="Nomor WhatsApp *" className="border rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-orange-400" />
            <textarea name="pesan" required placeholder="Ada yang bisa dibantu? *" rows={3} className="border rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-orange-400" />
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col gap-6 justify-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-gray-700">Jl. Raya Contoh No.99, Example, Indonesia 10101</div>
            </div>
          </div>
          <div className="rounded-xl overflow-hidden mt-2">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d590.3390180101454!2d106.77850243592555!3d-6.229217739559027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f1819b15e725%3A0x7a17eef77b277737!2sKuliner%20Nusantara!5e1!3m2!1sid!2sid!4v1756491897065!5m2!1sid!2sid"
              height="120"
              style={{ border: 0 }}
