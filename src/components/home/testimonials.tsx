...
const testimonialsRow1 = [
  {
    ...
    text: "Rasanya autentik banget, praktis dibawa bekal ke kantor. Nggak kalah sama masakan restoran.",
    avatar: "/img/user.jpg",
  },
  {
    name: "Budi",
    role: "Wiraswasta",
    text: "Saya sering sibuk urus usaha, produk ini solusi cepat untuk makan enak tanpa buang waktu di dapur.",
    avatar: "/img/user.jpg",
  },
  {
    name: "Clara",
    role: "Food Vlogger",
    text: "Sebagai reviewer makanan, jujur ini recommended! Rasa bumbu Nusantaranya kental dan konsisten di setiap suapan.",
    avatar: "/img/user.jpg",
  },
];
...
const testimonialsRow2 = [
  {
    ...
    text: "Anak-anak doyan banget. Tinggal panasin, langsung siap saji. Jadi nggak ribet kalau lagi banyak kerjaan rumah.",
    avatar: "/img/user.jpg",
  },
  {
    name: "Rizky",
    role: "Mahasiswa Perantau",
    text: "Produk ini benar-benar penyelamat. Praktis, porsinya pas, dan rasanya bikin kangen masakan rumah.",
    avatar: "/img/user.jpg",
  },
  {
    name: "Dian",
    role: "Hobby Makan",
    text: "Buat saya yang hobi eksplor rasa, paket ini worth it banget. Bisa nikmatin variasi masakan Nusantara tanpa repot.",
    avatar: "/img/user.jpg",
  },
];
...
export default function TestimonialSection() {
  ...
  useEffect(() => {
    ...
    function step1(ts: number) {
      ...
      const scrollAmount =
        (speed1 * elapsed) %
        (scrollContainer1.scrollWidth - scrollContainer1.clientWidth + 320);
    ...
    function step2(ts: number) {
      ...
      const scrollAmount =
        (speed2 * elapsed) %
        (scrollContainer2.scrollWidth - scrollContainer2.clientWidth + 320);
  ...
  const TestimonialCard = ({
    ...
    >
      ...
      <Image
        ...
        width={20}
        height={20}
        className="text-orange-500 w-5 h-5 md:w-6 md:h-6 mb-3"
      />
  ...
  return (
    <section id="testimoni" className="w-full py-36 bg-white relative overflow-hidden">
      ...
      <img
        ...
        width={120}
        height={120}
        className="absolute top-0 left-0 z-0 mt-2 ml-2 md:mt-0 md:ml-0"
      />
      <img
        src="/img/corner.png"
        alt="corner"
        width={120}
        height={120}
        className="absolute bottom-0 right-0 rotate-180 z-0 mb-2 mr-2 md:mb-0 md:mr-0"
      />
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 lg:mb-6">
              Kisah <span className="text-orange-600">Rasa Nusantara</span>,
              <br />
              Dari Mereka Yang{" "}
              <span className="text-orange-600">Sudah Coba.</span>
            </h2>
