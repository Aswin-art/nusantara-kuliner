		...
		<>
			...
			>
				...
				<div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gradient-to-r from-orange-50 to-red-50">
					<div className="flex items-center gap-3">
						<img src="/img/logo.png" alt="Nusantara Kuliner" className="w-10 h-8" />
						<span className="text-lg font-semibold text-gray-800">Nusantara Kuliner</span>
					</div>
					<button
						onClick={() => setOpen(false)}
				...
				<div className="px-6 py-8">
					...
					{/* Contact Info */}
					<div className="mt-8 pt-6 border-t border-gray-100">
						<h3 className="text-sm font-semibold text-gray-800 mb-3">Hubungi Kami</h3>
