			...
			<div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
				...
				<div className="flex flex-col gap-6 order-2 md:order-1">
					<h1 className="text-2xl md:text-4xl font-bold leading-snug">
						Hangatnya Rasa <span className="text-orange-600">Nusantara</span>,<br />
						<span className="text-orange-600">Siap Disajikan</span> Kapan Saja
					</h1>
					<p className="mt-2 text-gray-700 text-lg">
						Temukan rasa yang kaya dari kuliner <b>Nusantara</b> yang dimasak dengan <b>rempah premium</b> petani lokal, <b>tanpa pengawet</b>, dan <b>kemasan higienis</b>. Siap saji, hangatnya rasa <b>Nusantara</b>.
					</p>
