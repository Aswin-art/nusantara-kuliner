        ...
        <div className="bg-white w-full rounded-md shadow-lg grid md:grid-cols-2 gap-12 py-16 px-10 md:px-20 relative">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-700 leading-relaxed">
              Menjadi pelopor kuliner sehat berbasis rempah Nusantara yang tidak hanya menghadirkan cita rasa otentik, 
              tetapi juga menginspirasi masyarakat di seluruh dunia untuk menjalani gaya hidup yang praktis, sehat, 
              dan berkualitas.
            </p>
          </div>
          ...
          {/* Misi */}
            ...
            <ul className="text-gray-700 leading-relaxed list-disc list-inside space-y-2">
              <li>Menghadirkan makanan instan bebas pengawet sintetis bercita rasa autentik</li>
              <li>Menggunakan rempah alami sebagai pengawet sekaligus penambah rasa</li>
              <li>Mengedepankan keberlanjutan dengan bahan baku dari petani lokal</li>
              <li>Memperkenalkan kekayaan kuliner Nusantara ke panggung global</li>
